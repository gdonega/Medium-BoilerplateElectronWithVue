...
const DIST_PATH = path.join(__dirname, "../../../buildOutputs/prodDependencies/webpacks/vue");  // Onde todos os arquivos de saída do webpack do vue estão
const scheme = "app";
...
function requestHandler(req, next) {
  ...
  if (reqPath === "/") {
    reqPath = "/index.html"; // Arquivo que será carregado quando for chamado '/'. Nesse caso é html principal do webpack Vue.js
  }
